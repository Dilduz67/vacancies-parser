class Vacancy:
    def __init__(self, job_id,job_name, job_url, salary_from, salary_to, salary_str, reqiurements, responsibility, location, firm_name):
        self.id=job_id
        ...
        self.reqiurements = reqiurements
